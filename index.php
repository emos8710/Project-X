...
<body>
	...
	<main>
		<div class="innertube">
			<h2>Welcome to Upstrain!</h2>
			<p>Upstrain is the plasmid database for the Uppsala iGEM association, where information is stored about
                            ...
                            and reuse previous work. </p>
                        <br>
                        <br>
                        <h3>About iGEM </h3>
                        <p>iGEM stands for International Genetically Engineered Machine and it is an annual competition in
                        ...
                        <br>
                        <h3>About Upstrain</h3>
                        <p>The Upstrain database was created in 2018 as a data storage solution for the iGEM Uppsala team. Before the database was 
