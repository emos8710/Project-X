...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 08, 2018 at 05:34 PM
...
--
DELIMITER $$
CREATE TRIGGER `backbone_after_insert` AFTER INSERT ON `backbone` FOR EACH ROW BEGIN
insert into event_log (object, object_id, time, type) values("Backbone", new.id, NOW(), "Added");
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `backbone_after_update` AFTER UPDATE ON `backbone` FOR EACH ROW BEGIN
insert into event_log (object, object_id, time, type) values("Backbone", old.id, NOW(), "Edited");
insert into backbone_log(BB_reg, comment, creator, date_db, id, name, time, type, private) values(old.BB_reg, old.comment, old.creator, old.date_db, old.id, old.name, UNIX_TIMESTAMP(NOW()), "Edited", old.private);
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `backbone_before_delete` BEFORE DELETE ON `backbone` FOR EACH ROW BEGIN
insert into event_log (object, object_id, time, type) values("Backbone", old.id, NOW(), "Deleted");
insert into backbone_log(BB_reg, comment, creator, date_db, id, name, time, type, private) values(old.BB_reg, old.comment, old.creator, old.date_db, old.id, old.name, UNIX_TIMESTAMP(NOW()), "Deleted", old.private);
END
$$
DELIMITER ;
...
--
DELIMITER $$
CREATE TRIGGER `entry_after_insert` AFTER INSERT ON `entry` FOR EACH ROW BEGIN
INSERT INTO event_log(object, object_id, time, type) VALUES("Entry",NEW.id, NOW(), "Added");
INSERT INTO entry_upstrain (entry_id,upstrain_id) VALUES (new.id,CONCAT("UU",new.year_created,new.id));
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `entry_after_update` AFTER UPDATE ON `entry` FOR EACH ROW BEGIN
insert into event_log(object, object_id, time, type) values("Entry", OLD.id, NOW(), "Edited");
INSERT INTO entry_log(backbone, comment, creator, date_db, entry_reg, id, private, strain, year_created, type, time, created) VALUES(OLD.backbone, OLD.comment, OLD.creator, OLD.date_db, OLD.entry_reg, OLD.id, OLD.private, OLD.strain, OLD.year_created, "Edited", UNIX_TIMESTAMP(NOW()), old.created);
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `entry_before_delete` BEFORE DELETE ON `entry` FOR EACH ROW BEGIN
INSERT INTO event_log(object, object_id, time, type) VALUES("Entry", OLD.id, NOW(), "Deleted");
INSERT into entry_log(backbone, comment, creator, date_db, entry_reg, id, private, strain, year_created, type, time, created) VALUES(OLD.backbone, OLD.comment, OLD.creator, OLD.date_db, OLD.entry_reg, OLD.id, OLD.private, OLD.strain, OLD.year_created, "Deleted", UNIX_TIMESTAMP(NOW()), old.created);
END
$$
DELIMITER ;
...
CREATE TABLE IF NOT EXISTS `entry_inserts` (
  ...
  UNIQUE KEY `entry_position` (`entry_id`,`position`) USING BTREE,
  KEY `ins` (`insert_id`)
...
--
DELIMITER $$
CREATE TRIGGER `entryinsert_after_update` AFTER UPDATE ON `entry_inserts` FOR EACH ROW BEGIN
insert into event_log(object, object_id, time, type) values("Entry-insert link", CONCAT(old.entry_id, "-", old.insert_id), NOW(), "Edited");
insert into entry_inserts_log(entry_id, insert_id, position, time, type) values(old.entry_id, old.insert_id, old.position, UNIX_TIMESTAMP(NOW()), "Edited");
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `entryinsert_before_delete` BEFORE DELETE ON `entry_inserts` FOR EACH ROW BEGIN
insert into event_log(object, object_id, time, type) values("Entry-insert link", CONCAT(old.entry_id, "-", old.insert_id), NOW(), "Delete");
insert into entry_inserts_log(entry_id, insert_id, position, time, type) values(old.entry_id, old.insert_id, old.position, UNIX_TIMESTAMP(NOW()), "Deleted");
END
$$
DELIMITER ;
DELIMITER $$
...
(001, 3, 3, 2, 'Edited', 1520451619),
(001, 3, 4, 3, 'Deleted', 1520451666),
(001, 5, 3, 4, 'Edited', 1520451781),
(001, 5, 4, 5, 'Edited', 1520451802),
(001, 3, 4, 6, 'Deleted', 1520453717),
(001, 5, 5, 7, 'Edited', 1520453722),
(001, 5, 4, 8, 'Deleted', 1520453754);
...
(001, 'testestestest', 2018, '2018-02-07', 'test', 2, 1, 1, 0, 3, 'Edited', 1520445295, 1),
(001, 'testestestest', 2018, '2018-02-07', 'BBa_K1337', 2, 1, 1, 0, 4, 'Edited', 1520449486, 1);
...
(001, 'User', 'Edited', 75, '2018-03-07 18:24:46'),
(011, 'User', 'Edited', 76, '2018-03-07 18:43:31'),
(001, 'User', 'Edited', 77, '2018-03-07 18:45:23'),
(001, 'Entry', 'Edited', 78, '2018-03-07 18:54:55'),
(010, 'User', 'Edited', 79, '2018-03-07 18:58:51'),
(001, 'User', 'Edited', 80, '2018-03-07 19:09:16'),
(001, 'User', 'Edited', 81, '2018-03-07 19:11:54'),
(001, 'Entry', 'Edited', 82, '2018-03-07 20:04:46'),
(001, 'Entry-insert link', 'Edited', 83, '2018-03-07 20:40:19'),
(001, 'Entry-insert link', 'Added', 84, '2018-03-07 20:40:37'),
(001, 'Entry-insert link', 'Delete', 85, '2018-03-07 20:41:06'),
(001, 'Entry-insert link', 'Edited', 86, '2018-03-07 20:43:01'),
(001, 'Entry-insert link', 'Added', 87, '2018-03-07 20:43:01'),
(001, 'Entry-insert link', 'Edited', 88, '2018-03-07 20:43:22'),
(001, 'Entry-insert link', 'Added', 89, '2018-03-07 20:43:22'),
(001, 'Entry-insert link', 'Delete', 90, '2018-03-07 21:15:17'),
(001, 'Entry-insert link', 'Edited', 91, '2018-03-07 21:15:22'),
(001, 'Entry-insert link', 'Delete', 92, '2018-03-07 21:15:54'),
(001, 'User', 'Edited', 93, '2018-03-07 22:11:09');
...
--
DELIMITER $$
CREATE TRIGGER `ins_after_update` AFTER UPDATE ON `ins` FOR EACH ROW BEGIN
insert into event_log(object, object_id, time, type) values("Insert", old.id, NOW(), "Edited");
insert into ins_log(comment, creator, date_db, id, ins_reg, name, time, type, event_type, private) values(old.comment, old.creator, old.date_db, old.id, old.ins_reg, old.name, UNIX_TIMESTAMP(NOW()), old.type, "Edited", old.private);
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `ins_before_delete` BEFORE DELETE ON `ins` FOR EACH ROW BEGIN
insert into event_log(object, object_id, time, type) values("Insert", old.id, NOW(), "Deleted");
insert into ins_log(comment, creator, date_db, id, ins_reg, name, time, event_type, type, private) values(old.comment, old.creator, old.date_db, old.id, old. ins_reg, old.name, UNIX_TIMESTAMP(NOW()), "Deleted", old.type, old.private);
END
$$
DELIMITER ;
DELIMITER $$
...
--
DELIMITER $$
CREATE TRIGGER `instype_after_update` AFTER UPDATE ON `ins_type` FOR EACH ROW BEGIN
insert into event_log(object, object_id, time, type) values("Insert type", old.id, NOW(), "Edited");
insert into ins_type_log(id, name, time, type) values(old.id, old.name, UNIX_TIMESTAMP(NOW()), "Edited");
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `instype_before_delete` BEFORE DELETE ON `ins_type` FOR EACH ROW BEGIN
insert into event_log(object, object_id, time, type) values("Insert type", old.id, NOW(), "Deleted");
insert into ins_type_log(id, name, time, type) values(old.id, old.name, UNIX_TIMESTAMP(NOW()), "Deleted");
END
$$
DELIMITER ;
DELIMITER $$
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `strain_after_update` AFTER UPDATE ON `strain` FOR EACH ROW BEGIN
insert into event_log(object, object_id, time, type) values("Strain", old.id, NOW(), "Edited");
insert into strain_log(comment, id, name, time, type, date_db, private, creator) values(old.comment, old.id, old.name, UNIX_TIMESTAMP(NOW()), "Edited", old.date_db, old.private, old.creator);
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `strain_before_delete` BEFORE DELETE ON `strain` FOR EACH ROW BEGIN
insert into event_log(object, object_id, time, type) values("Strain", old.id, NOW(), "Deleted");
insert into strain_log(comment, id, name, time, type, date_db, private, creator) values(old.comment, old.id, old.name, UNIX_TIMESTAMP(NOW()), "Deleted", old.date_db, old.private, old.creator);
END
$$
DELIMITER ;
...
CREATE TABLE IF NOT EXISTS `upstrain_file` (
  ...
  `name_new` varchar(20) GENERATED ALWAYS AS (concat(`upstrain_id`,'.fasta')),
  PRIMARY KEY (`upstrain_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
insert into event_log(object, object_id, time, type) values("User", OLD.user_id, NOW(), "Edited");
insert into users_log(active, admin, email, first_name, hash, last_name, password, phone, username, user_id, time, type) values(old.active, old.admin, old.email, old.first_name, old.hash, old.last_name, old.password, old.phone, old.username, old.user_id, UNIX_TIMESTAMP(NOW()), "Edited");
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `user_before_delete` BEFORE DELETE ON `users` FOR EACH ROW BEGIN
INSERT INTO event_log(object, object_id, time, type) VALUES("User", OLD.user_id, NOW(), "Deleted");
insert into users_log(active, admin, email, first_name, hash, last_name, password, phone, username, user_id, time, type) values(old.active, old.admin, old.email, old.first_name, old.hash, old.last_name, old.password, old.phone, old.username, old.user_id, UNIX_TIMESTAMP(NOW()), "Deleted");
END
$$
DELIMITER ;
...
(1, 'test', 'testson', 'mail@mail.com', '0123456789', 'testy', '', '', 0, 0, 31, 'Edited', 1520443486),
(11, 'Wiktor', 'Gustafsson', 'wiktorg.95@gmail.com', '761059274', 'wigu95', '$2y$10$lgJ0qp.84./MrDnzB9jh7.rB8tqFeG3nmjmy.SbqPZfT/Hv6pzKj.', 'f899139df5e1059396431415e770c6dd', 0, 0, 32, 'Edited', 1520444611),
(1, 'test', 'testson', 'mail@mail.com', '0123456789', 'testy', '', '', 0, 0, 33, 'Edited', 1520444723),
(10, 'Fredrik', 'Lindeberg', 'fredrik.lindeberg@igemuppsala.se', '', 'FredrikLindeberg', '$2y$10$E5YGenXrBZRwdFVSiFp4TuLVLGayAmZo8mJeaxrG7jKMTHEVaNBTi', '912d2b1c7b2826caf99687388d2e8f7c', 1, 1, 34, 'Edited', 1520445531),
(1, 'test', 'testson', 'mail@mail.com', '0123456789', 'testmaster', '', '', 0, 0, 35, 'Edited', 1520446156),
(1, 'test', 'testson', 'email@email.com', '0123456789', 'testlord', '', '', 0, 0, 36, 'Edited', 1520446314),
(1, 'test', 'testson', 'mail@mail.com', '0123456789', 'testy', '', '', 0, 0, 37, 'Edited', 1520457069);
...
-- Events
--
CREATE EVENT `AutoDeleteBackboneLog` ON SCHEDULE EVERY 1 DAY STARTS '2018-02-28 14:27:32' ON COMPLETION PRESERVE ENABLE DO DELETE LOW_PRIORITY FROM upstrain.backbone_log WHERE FROM_UNIXTIME(time) < DATE_SUB(NOW(), INTERVAL 30 DAY)$$

CREATE EVENT `AutoDeleteEntryInsertLog` ON SCHEDULE EVERY 1 DAY STARTS '2018-02-28 14:35:41' ON COMPLETION PRESERVE ENABLE DO DELETE LOW_PRIORITY FROM upstrain.entry_inserts_log WHERE FROM_UNIXTIME(time) < DATE_SUB(NOW(), INTERVAL 30 DAY)$$

CREATE EVENT `AutoDeleteStrainLog` ON SCHEDULE EVERY 1 DAY STARTS '2018-02-28 14:28:15' ON COMPLETION PRESERVE ENABLE DO DELETE LOW_PRIORITY FROM upstrain.strain_log WHERE FROM_UNIXTIME(time) < DATE_SUB(NOW(), INTERVAL 30 DAY)$$

CREATE EVENT `AutoDeleteInsertLog` ON SCHEDULE EVERY 1 DAY STARTS '2018-02-28 11:23:13' ON COMPLETION PRESERVE ENABLE DO DELETE LOW_PRIORITY FROM upstrain.ins_log WHERE FROM_UNIXTIME(time) < DATE_SUB(NOW(), INTERVAL 30 DAY)$$

CREATE EVENT `AutoEmptyLog` ON SCHEDULE EVERY 1 DAY STARTS '2018-02-26 13:04:33' ON COMPLETION PRESERVE ENABLE DO DELETE LOW_PRIORITY FROM upstrain.event_log WHERE FROM_UNIXTIME(time) < DATE_SUB(NOW(), INTERVAL 30 DAY)$$

CREATE EVENT `AutoDeleteInstypeLog` ON SCHEDULE EVERY 1 DAY STARTS '2018-03-02 10:00:28' ON COMPLETION PRESERVE ENABLE DO DELETE LOW_PRIORITY FROM upstrain.ins_type_log WHERE FROM_UNIXTIME(time) < DATE_SUB(NOW(), INTERVAL 30 DAY)$$

CREATE EVENT `AutoDeleteUserLog` ON SCHEDULE EVERY 1 DAY STARTS '2018-02-26 12:57:31' ON COMPLETION PRESERVE ENABLE DO DELETE LOW_PRIORITY FROM upstrain.users_log WHERE FROM_UNIXTIME(time) < DATE_SUB(NOW(), INTERVAL 30 DAY)$$

CREATE EVENT `AutoDeleteEntryLog` ON SCHEDULE EVERY 1 DAY STARTS '2018-02-26 12:57:57' ON COMPLETION PRESERVE ENABLE DO DELETE LOW_PRIORITY FROM upstrain.entry_log WHERE FROM_UNIXTIME(time) < DATE_SUB(NOW(), INTERVAL 30 DAY)$$
