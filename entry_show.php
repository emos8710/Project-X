...
$entrysql = "SELECT entry.comment AS cmt, entry.year_created AS year, entry_upstrain.upstrain_id AS uid, "
        . "entry.date_db AS date, entry.entry_reg AS biobrick, entry.private, strain.name AS strain, "
        ...
        <div class="entry_table">
            <table class="entry">
                ...
                <tr>
                    ...
                    <td><?php
                        if ($entrydata["biobrick"] === null || $entrydata["biobrick"] == '') {
                            ...
                            echo "<a class=\"external\" href=\"http://parts.igem.org/Part:" . $entrydata["biobrick"] . "\" target=\"_blank\">" . $entrydata["biobrick"] . "</a>";
                        }
                        ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><?php
                        if ($hasfile) {
                            echo "<strong>Download sequence (FASTA):</strong>";
                        }
                        ?></td>
                    <td><?php
                        if ($hasfile) {
                            echo "<a href=\"files/" . $filedata["filename"] . "\" download>" . $filedata["filename"] . "</a>";
                        }
                        ?></td>
                </tr>
            </table>
