...
if ($loggedin && $active && $admin) {
    ...
    if (isset($_GET['content'])) {
        ...
        <div class="edit_users">
            <ul>
                <!-- Edit name -->
                <li><div class="edit_title">Name</div>	<?php echo $info["name"];
        if ($current_content != "insert_name") {
            ?>
                ...
                <!-- Edit insert type -->
                <li><div class="edit_title">Insert type</div> <?php echo $info["type"];
        ...
        <?php } ?>                        
                ...
                <li><div class="edit_title">Biobrick registry id</div> <?php echo $info["biobrick"];
        ...
        <?php } ?>
                ...
                <!-- Edit comment -->
                <li><div class="edit_title">Comment</div> <?php echo $info["comment"];
        ...
        <?php if ($current_content == "comment") { ?>
                ...
                <!-- Edit private -->
                <li><div class="edit_title">Private</div> <?php if ($info["private"] == 1) { echo "Yes"; } else { echo "No"; }
    ...
    <?php if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($update_msg)): echo "<br>" . $update_msg;
                ...
                <!-- Back button -->
                <div class="back"><a href="?backbone_id=<?php echo $part_id; ?>">Back to strain page</a></div>
